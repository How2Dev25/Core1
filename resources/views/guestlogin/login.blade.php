    ...
    <div class="grid md:grid-cols-2 gap-0">
      ...
      <div class="p-6">
        ...
        <div>
          <form autocomplete="off" action="/guestloginform" method="POST">
            ...
            <div class="mb-4">
              ...
              <div class="relative">
                ...
                <button type="button"
                  ...
                  <svg id="eye-slash-icon" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 hidden" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path fill-rule="evenodd"
            ...
            <!-- Sign In Button -->
            <button id="login-btn" type="submit" class="w-full btn-primary btn py-2 text-sm">
              Sign in
            </button>
          </form>
      ...
      <div class="bg-white/5 p-6 flex flex-col justify-center border-l border-white/10">
        ...
        <div class="space-y-3">
          <!-- Google Login -->
          <a href="/auth/google"
            class="flex items-center justify-center py-2.5 px-4 bg-white text-gray-800 rounded-lg shadow-md hover:bg-gray-100 hover:shadow-lg transition duration-200 group">
            <div class="flex items-center space-x-2">
              <img src="{{ asset('images/defaults/google.png') }}"
                class="h-5 w-5 transition-transform duration-200 group-hover:scale-110" alt="Google">
              <span class="font-medium text-sm text-gray-800 group-hover:text-blue-600 transition-colors duration-200">
          ...
          <a href="/employeelogin"
            class="flex items-center justify-center py-2.5 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg shadow-md hover:from-blue-700 hover:to-blue-800 hover:shadow-lg transition duration-200 group">
            <div class="flex items-center space-x-2">
              <svg class="h-5 w-5 transition-transform duration-200 group-hover:scale-110" fill="currentColor"
                viewBox="0 0 20 20">
                <path fill-rule="evenodd"
