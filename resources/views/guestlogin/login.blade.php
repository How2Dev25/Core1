          ...
          <div data-aos="zoom-in-up" data-aos-delay="400" class="space-y-4">
            <div class="flex items-start">
              <div class="flex-shrink-0 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                  ...
                  class="lucide lucide-concierge-bell text-amber-400">
            ...
            <div class="flex items-start">
              <div class="flex-shrink-0 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-calendar-check text-amber-400">
        ...
        <div class="max-w-md w-full bg-white/10 backdrop-blur-lg p-6 rounded-xl shadow-2xl border border-white/20">
          ...
          <div>
            <form autocomplete="off" action="/guestloginform" method="POST">
              ...
              <!-- Sign In Button -->
              <button id="login-btn" type="submit" class="w-full btn-primary btn">
                Sign in
              </button>
            </form>
            ...
            <div class="mt-6 space-y-4">
              ...
              <div class="flex justify-center mt-4">
                <a href="/auth/google" class="flex items-center justify-center w-full max-w-sm py-3 px-4 bg-white text-gray-800 border border-gray-300 rounded-lg shadow-md 
