        ...
        <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($eventtypes as $eventtype)
                <div
                    ...
                    <div class="relative h-56 overflow-hidden">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-b from-indigo-900/40 via-transparent to-gray-900/60">
                        </div>
            ...
            @empty
                <div
                    ...
                    <p class="text-gray-600 text-base max-w-md">Sorry, no events and conferences are available at this
                        moment. Please
