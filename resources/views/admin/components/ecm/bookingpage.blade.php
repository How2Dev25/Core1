...
<body>
    <section class="p-6  min-h-screen ">
        <form autocomplete="off" action="/bookthisevent" method="POST" id="eventBookingForm" class="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto">
            @csrf
            <input value="{{$eventtype->eventtype_ID}}" type="hidden" name="eventtype_ID" id="selectedEventTypeID" />
    ...
    <div class="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        <div class="bg-gradient-to-r from-[#001f54]/5 to-[#1a3470]/5 p-4 rounded-2xl text-center border border-[#001f54]/10">
                        ...
                        <div class="bg-gradient-to-r from-[#001f54]/5 to-[#1a3470]/5 p-4 rounded-2xl text-center border border-[#001f54]/10">
                            ...
                            <p class="text-lg font-semibold {{ $eventtype->eventtype_status == 'Active' ? 'text-green-600' : 'text-red-600' }}">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                 viewBox="0 0 24 24" fill="none" stroke="#F7B32B" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        ...
        <div class="bg-gradient-to-r from-[#001f54]/5 to-[#1a3470]/5 p-4 rounded-2xl text-center border border-[#001f54]/10">
            <p class="text-sm text-gray-500">Status</p>
            <p class="text-lg font-semibold {{ $eventtype->facility_status == 'Available' ? 'text-green-600' : 'text-red-600' }}">
                ...
                <div class="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="form-control">
                            ...
                            <input type="date" name="event_checkin" id="eventCheckin" class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" required />
                        </div>

                        <div class="form-control">
                            <label class="label font-semibold text-[#001f54] mb-2">
                                <span class="flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M8 2v4"></path>
                                        <path d="M16 2v4"></path>
                                        <rect width="18" height="18" x="3" y="4" rx="2"></rect>
                                        <path d="M3 10h18"></path>
                            ...
                            <input type="date" name="event_checkout" id="eventCheckout" class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" required />
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="event_numguest" id="eventNumGuest" min="1" max="{{ $eventtype->eventtype_capacity }}" class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" required />
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="event_name" placeholder="e.g., Company Annual Party" class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" required />
                        </div>
                        ...
                        <div class="form-control md:col-span-2">
                            ...
                            <textarea name="event_specialrequest" placeholder="Special decorations, catering requirements, etc." class="textarea textarea-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" rows="2"></textarea>
                        </div>
                        ...
                        <div class="form-control md:col-span-2">
                            ...
                            <textarea name="event_equipment" placeholder="Audio system, projectors, tables, etc." class="textarea textarea-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" rows="2"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/20 lg:sticky lg:top-6 ">
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-[#001f54]/5 to-[#1a3470]/5 border border-[#001f54]/10">
                            ...
                            <span id="eventPrice" class="font-bold text-[#001f54]">₱{{ number_format($eventtype->eventtype_price, 2) }}</span>
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <label class="flex items-center gap-4 p-4 border-2 border-gray-200 rounded-2xl cursor-pointer hover:border-[#001f54] hover:bg-[#001f54]/5 transition-all duration-300">
                                <input type="radio" name="event_paymentmethod" value="Pay at Venue" class="radio radio-primary" checked>
                            ...
                            <!-- Online Payment -->
                            <label class="flex items-center gap-4 p-4 border-2 border-gray-200 rounded-2xl cursor-pointer hover:border-[#001f54] hover:bg-[#001f54]/5 transition-all duration-300">
                                <input type="radio" name="event_paymentmethod" value="Online Payment" class="radio radio-primary">
                                <div class="p-2 bg-green-500 rounded-xl">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <rect x="1" y="3" width="15" height="13"></rect>
                                        <path d="m16 8 2-2 2 2"></path>
                                        <path d="M21 14V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h11"></path>
                                        <path d="M5 12V极速赛车开奖直播 历史记录 澳洲幸运10开奖结果 飞飞加拿大预测2.8 幸运飞行艇开奖结果" class="hidden"></path>
                                    </svg>
                                </div>
                                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                     ...
                     <button onclick="document.getElementById('confirm_modal_bas').showModal()" type="button"
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const eventPrice = parseFloat("{{ $eventtype->eventtype_price }}"); // Blade injects price
    ...
    function calculateBilling() {
        ...
        if (checkin && checkout && checkout > checkin) {
            // Calculate number of days (inclusive of check-in)
            const diffTime = checkout - checkin;
            const days = Math.ceil(diffTime / (1000 * 60 * 60 * 24));
            
            numDaysSpan.textContent = days;
            const total = days * eventPrice;
