...
<div class="collapse group">
    ...
    <a href="/guestaccount" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
      <span class="flex items-center gap-2">
        ...
        <div class="collapse group">
          ...
          <div class="collapse-content pl-14 pr-4 py-1 space-y-1"> 
            <a href="/roomfeedback" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
              <span class="flex items-center gap-2">
  ...
  <div class="collapse-content pl-14 pr-4 py-1 space-y-1"> 
    <!-- Events -->
    <a href="/ecm" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
      <span class="flex items-center gap-2">
    ...
    <!-- Conference -->
    <a href="/conference" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
      <span class="flex items-center gap-2">
    ...
    <!-- Facilities -->
    <a href="/facilities" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
      <span class="flex items-center gap-2">
        <i data-lucide="building-2" class="w-4 h-4 text-[#F7B32B]"></i>
        Facilities
      </span>
