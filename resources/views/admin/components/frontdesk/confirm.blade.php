<dialog id="confirm_reservation_{{$reserveroom->reservationID}}" class="modal">
  <div class="modal-box max-w-md">
    ...
    <p class="mb-6 text-sm text-gray-700">Are you sure you want to Confirm reservation for <span class="font-bold">{{$reserveroom->reservation_bookingID}} for {{$reserveroom->guestname}}</span> This action cannot be undone.</p>
