            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 transition-slow">
                    ...
                    <section class="p-5">
                        ...
                        <form autocomplete="off" action="/createreservation" method="POST" id="reservationForm"
                            class="flex flex-col lg:flex-row gap-6">
                            @csrf

                            <input required type="hidden" name="roomID" id="selectedRoomID" />
                                                ...
                                                <div class="card-body p-4 space-y-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="flex items-center gap-1"><i data-lucide="square"
                                                                class="w-3 h-3"></i> {{$room->roomsize}} sq.ft</span>
                                                        <span class="flex items-center gap-1"><i data-lucide="users"
                                                                class="w-3 h-3"></i> {{$room->roommaxguest}} Guests</span>
                                                        <span class="flex items-center gap-1"><i data-lucide="wifi"
                                                                class="w-3 h-3"></i> {{$room->roomfeatures}}</span>
                                                    </div>
                                                </div>
                                                <div
                                ...
                                <div class="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/20">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="form-control">
                                            ...
                                            <input required type="date" name="reservation_checkin"
                                        ...
                                        <div class="form-control">
                                            ...
                                            <input type="date" name="reservation_checkout" min="{{ now()->toDateString() }}"
                                                class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors"
                                                required />
                                        </div>
