              ...
              @forelse ($masterRFID as $rfidmaster)
                <div class="master-rfid-card card bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] group"
                    ...
                    <div class="card-body p-5">
                        ...
                        <!-- DOORLOCK ASSIGNMENT DISPLAY - ADDED HERE -->
                        <div class="mt-2 mb-3">
                            @if($rfidmaster->doorlockID)
                              <div class="flex items-center gap-2 p-2 bg-blue-50 rounded-lg border border-blue-100">
                                  ...
                                  <div>
                                      <p class="text-xs text-blue-600">Assigned to Doorlock</p>
                                      <p class="text-sm font-bold text-gray-800">ID: {{ $rfidmaster->doorlockID }} | Room # {{ $rfidmaster->room_number }}</p>
                                  </div>
                              </div>
                            @else
                              <div class="flex items-center gap-2 p-2 bg-gray-50 rounded-lg border border-gray-200">
                                  <div class="bg-gray-400 p-1.5 rounded-lg">
                                      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                                      </svg>
                                  </div>
                                  <p class="text-sm text-gray-500 italic">Not assigned to any door</p>
                              </div>
                            @endif
                        </div>
                ...
                <!-- Edit Modal for this Master RFID -->
