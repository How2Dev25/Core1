            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
              ...
              <div class="card bg-white shadow-md
                ...
                <div class="card-body p-5">
                  ...
                  <p class="text-3xl font-bold mt-3 text-gray-800 group-hover:text-blue-900 transition-colors">
                    {{$totalrooms}}</p>
                </div>
              </div>
              ...
              <div class="card bg-white shadow-md
                ...
                <div class="card-body p-5">
                  ...
                  <p class="text-3xl font-bold mt-3 text-gray-800 group-hover:text-red-900 transition-colors">
                    {{$occupiedrooms}}</p>
                </div>
              </div>
              ...
              <div class="card bg-white shadow-md
                ...
                <div class="card-body p-5">
                  ...
                  <p class="text-3xl font-bold mt-3 text-gray-800 group-hover:text-green-900 transition-colors">
                    {{$availablerooms}}</p>
                </div>
              </div>
              ...
              <div class="card bg-white shadow-md
                ...
                <div class="card-body p-5">
                  ...
                  <p class="text-3xl font-bold mt-3 text-gray-800 group-hover:text-amber-900 transition-colors">
                    {{$maintenancerooms}}</p>
                </div>
              </div>
            </div>
            ...
            <div class="mb-10">
                ...
                <form method="GET" action="/roommanagement" class="flex gap-2">
                  ...
                  <select name="category" class="select select-bordered select-sm" onchange="this.form.submit()">
                    ...
                    @forelse ($roomtypes as $roomtype)
                      <option value="{{ $roomtype->roomtype_name }}" {{ request('category') == $roomtype->roomtype_name ? 'selected' : '' }}>
                  ...
                  <!-- Search Input -->
                  <div class="relative">
                    <input type="text" name="search" placeholder="Search rooms..." class="input input-bordered input-sm"
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @forelse($rooms as $room)
                  <div
                    class="card bg-white border border-gray-200 hover:shadow-md transition-all duration-300 overflow-hidden">
                    ...
                    <div class="card-body p-5">
                      ...
                      <div class="flex items-center gap-2 mt-3">
                        <div class="flex items-center text-sm text-gray-500">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="r ound" stroke-linejoin="round" stroke-width="2"
                              d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                          </svg>
                          {{$room->roomprice}} sqft
                        </div>
                      ...
                      <div class="mt-4 flex justify-between items-center">
                        ...
                        <div class="flex gap-2">
                          ...
                          <button onclick="delete_room_{{ $room->roomID }}.showModal()"
                ...
                @empty
                  <div
                    class="w-full text-center py-10 px-4 bg-base-100 rounded-md shadow-sm border border-dashed border-gray-300">
