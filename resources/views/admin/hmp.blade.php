              ...
              <div class="card border border-blue-100 bg-gradient-to-br from-blue-50 to-white
                ...
                <div class="card-body p-6">
                  <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 class="text-lg font-semibold text-gray-700 group-hover:text-blue-800 transition-colors">Active
                        Promotions</h3>
              ...
              <div class="card border border-amber-100 bg-gradient-to-br from-amber-50 to-white
                ...
                <div class="card-body p-6">
                  <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 class="text-lg font-semibold text-gray-700 group-hover:text-amber-800 transition-colors">
                        Engagement Rate</h3>
                  ...
                  <progress class="progress progress-warning w-full group-hover:bg-amber-200 transition-colors" value="78"
                    max="100"></progress>
                </div>
              </div>
            </div>
