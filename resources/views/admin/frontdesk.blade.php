              ...
              <div class="flex flex-col gap-5 w-full">
                <div class="w-full mt-5">
                  @if(Auth::user()->role === 'Hotel Admin')
                    <button onclick="openBookingReportWithOTP()" class="btn btn-primary">
                ...
                <div class="w-full mt-5">
                   @if(Auth::user()->role === 'Hotel Admin')
                  <button onclick="openEventReportWithOTP()" class="btn btn-primary">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v6m0 0l-3-3m3 3l3-3M5 5a2 2 0 00-2 2v10a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2H5z" />
      </svg>
      View Event Report
  </button>
  @endif
                ...
                <div class="w-full mt-5">
                   @if(Auth::user()->role === 'Hotel Admin')
                    <button onclick="openAdditionalReportWithOTP()" class="btn btn-primary">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                      </svg>
                      View Additional Items Report
                    </button>
                  @endif
