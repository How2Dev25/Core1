...
@auth
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Front Desk
          </h3>
          <p class="text-3xl font-bold text-gray-900 mt-2">{{ $moduleCounts['Front Desk And Reception'] ?? 0 }}</p>
    ...
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Booking &
            Reservation</h3>
          <p class="text-3xl font-bold text-gray-900 mt-2">{{ $moduleCounts['Booking And Reservation'] ?? 0 }}</p>
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Room
            Management</h3>
          <p class="text-3xl font-bold text-gray-900 mt-2">{{ $moduleCounts['Room Management And Service'] ?? 0 }}</p>
    ...
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Housekeeping
          </h3>
          <p class="text-3xl font-bold text-gray-900 mt-2">{{ $moduleCounts['Housekeeping And Maintenance'] ?? 0 }}</p>
    ...
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Inventory &
            Stocks</h3>
    ...
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Events &
            Conference</h3>
    ...
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Hotel
            Marketing</h3>
          <p class="text-3xl font-bold text-gray-900 mt-2">{{ $moduleCounts['Hotel Marketing And Promotion'] ?? 0 }}</p>
    ...
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Channel
            Management</h3>
    ...
    <div
      ...
      <div class="flex items-center justify-between">
        <div>
          <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wide group-hover:text-blue-700">Guest
            Relationship</h3>
          <p class="text-3xl font-bold text-gray-900 mt-2">{{ $moduleCounts['Guest Relationship Management'] ?? 0 }}</p>
