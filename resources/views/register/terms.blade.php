    ...
    <div class="relative z-10 w-full min-h-screen flex justify-center items-center p-4 flex-col md:flex-row">
      ...
      <div class="w-full md:w-1/2 flex justify-center items-center">
        <div class="max-w-md w-full bg-white/10 backdrop-blur-lg p-6 rounded-xl shadow-2xl border border-white/20">
          ...
          <!-- Scrollable T&C -->
          <div
            class="h-80 overflow-y-auto p-4 rounded-lg bg-white/5 border border-white/10 space-y-4 text-white/90 text-sm">
            ...
            <h3 class="text-lg font-semibold text-amber-400">4. Consumer Protection</h3>
            <p class="text-white/80 leading-relaxed">
              In line with the <span class="font-bold text-amber-300">Consumer Act of the Philippines (Republic Act No.
                7394)</span>,
              Soliera Hotel & Restaurant upholds fair trade practices and ensures the safety and quality of its
              services.
            ...
            <h3 class="text-lg font-semibold text-amber-400">5. Electronic Commerce</h3>
            <p class="text-white/80 leading-relaxed">
              In accordance with the <span class="font-bold text-amber-300">Electronic Commerce Act of 2000 (Republic
                Act No.
                8792)</span>,
            ...
            <h3 class="text-lg font-semibold text-amber-400">6. Guest Responsibilities</h3>
            <p class="text-white/80">
          ...
          <div class="mt-6">
            ...
            <button onclick="redirect()" id="continueBtn" disabled class="btn btn-primary w-full mt-2">
