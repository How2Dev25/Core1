    ...
    <div>
        <form action="/upload-photo" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <div class="relative mb-4">
                        <div id="image-preview" class="w-32 h-32 rounded-full bg-white/10 border-2 border-dashed border-white/30 flex items-center justify-center overflow-hidden">
                        ...
                        <button type="button" id="remove-image" class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center hidden">
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button type="button" id="open-camera" class="bg-white/5 border border-white/20 rounded-lg py-2 px-3 text-white/80 hover:bg-white/10 transition flex items-center justify-center">
                            <i class="fas fa-video mr-2"></i> Take Photo
                        </button>
                        <button type="button" id="retake-photo" class="bg-white/5 border border-white/20 rounded-lg py-2 px-3 text-white/80 hover:bg-white/10 transition flex items-center justify-center hidden">
                    ...
                    <div id="camera-feed" class="mt-4 hidden">
                        <div class="relative bg-black rounded-lg overflow-hidden">
                            ...
                            <div class="absolute bottom-0 left-0 right-0 bg-black/50 p-2 flex justify-center">
                                <button type="button" id="capture-btn" class="bg-white rounded-full w-12 h-12 flex items-center justify-center mx-auto">
            ...
            <div class="flex justify-between">
                <a href="/registration" class="font-medium text-blue-400 hover:text-blue-300 flex items-center">
