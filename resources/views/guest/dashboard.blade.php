                        ...
                        <section class=" min-h-screen">
                            ...
                            <div class="container mx-auto p-4 max-w-7xl">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                                    ...
                                    <!-- Total Reservations -->
                                    <div
                                        class="stat-card card bg-base-100 shadow-lg border-2 border-transparent hover:border-blue-400 hover:bg-gradient-to-br hover:from-blue-50 hover:to-blue-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group">
                                        <div class="card-body items-center text-center p-6">
                                            <div class="bg-blue-900 rounded-full p-4 mb-4">
                                                <i class="fa-solid fa-calendar-days w-8 h-8 text-yellow-400 text-3xl"></i>
                                            </div>
                                    ...
                                    <!-- Upcoming Events -->
                                    <div
                                        class="stat-card card bg-base-100 shadow-lg border-2 border-transparent hover:border-purple-400 hover:bg-gradient-to-br hover:from-purple-50 hover:to-purple-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group">
                                        <div class="card-body items-center text-center p-6">
                                            <div class="bg-blue-900 rounded-full p-4 mb-4">
                                                <i class="fa-solid fa-calendar-check w-8 h-8 text-yellow-400 text-3xl"></i>
                                            </div>
                                    ...
                                    <!-- Recent Reservation -->
                                    <div
                                        class="stat-card card bg-base-100 shadow-lg border-2 border-transparent hover:border-yellow-400 hover:bg-gradient-to-br hover:from-yellow-50 hover:to-yellow-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group">
                                        <div class="card-body items-center text-center p-6">
                                            <div class="bg-blue-900 rounded-full p-4 mb-4">
                                                <i class="fa-solid fa-clock w-8 h-8 text-yellow-400 text-3xl"></i>
                                            </div>
                                    ...
                                    <!-- Loyalty Points -->
                                    <div
                                        class="stat-card card bg-base-100 shadow-lg border-2 border-transparent hover:border-green-400 hover:bg-gradient-to-br hover:from-green-50 hover:to-green-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group">
                                        <div class="card-body items-center text-center p-6">
                                            <div class="bg-blue-900 rounded-full p-4 mb-4">
                                                <i class="fa-solid fa-coins w-8 h-8 text-yellow-400 text-3xl"></i>
                                            </div>
                                        ...
                                        <div class="relative w-full overflow-hidden">
                                                        ...
                                                        <div class="hero h-80 w-full"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="max-w-md">
                                                                    ...
                                                                    <h1 class="mb-5 text-4xl font-bold floating-animation">
                                                                        {{ $event->eventname }}
                                                                    </h1>
                                            ...
                                            <div
                                                ...
                                                <button onclick="prevEvent()"
                                                    class="btn btn-circle btn-primary shadow-lg hover:shadow-xl">
                                    ...
                                    <div class="card bg-white shadow-lg rounded-xl border border-gray-100 overflow-hidden">
                                        <div class="p-6">
                                            <h2 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                                                <div
                                                    class="w-10 h-10 rounded-lg flex items-center justify-center mr-3 bg-blue-900">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"
                                                        class="text-yellow-400">
                                                        <path
                                                            d="M21 10.78V8C21 6.9 20.1 6 19 6H5C3.9 6 3 6.9 3 8V10.78C3.39 10.47 3.86 10.25 4.4 10.17C5.28 10.05 6.2 10.36 6.85 11.01L10 14.16L13.15 11.01C14.45 9.71 16.55 9.71 17.85 11.01C18.39 11.55 18.71 12.27 18.74 13.03H21V10.78Z" />
                                                        <path
                                                            d="M2 19V17H22V19C22 20.1 21.1 21 20 21H4C2.9 21 2 20.1 2 19Z" />
                                                    </svg>
                                                </div>
                                                Featured Rooms
                                            </h2>
                                            ...
                                            <div class="relative w-full rounded-xl overflow-hidden" id="roomCarousel">
                                                @foreach($rooms as $index => $room)
                                                    <div class="carousel-slide {{ $index === 0 ? 'block' : 'hidden' }}">
                                                        <img src="{{ $room->roomphoto }}" alt="{{ $room->roomtype }}"
                                                            class="w-full h-80 object-cover rounded-xl">
                                                        <div
                                                            class="absolute inset-0 bg-gradient-to-r from-black/60 to-black/30 rounded-xl">
                                                        </div>
                                                        <div class="absolute inset-0 p-8 flex items-center">
                                                            <div class="text-white max-w-2xl">
                                                                <h3 class="text-3xl font-bold mb-3">{{ $room->roomtype }}</h3>
                                                                <p class="text-xl mb-2 opacity-90">{{ $room->roomsize }} sqm •
                                                                    Max {{ $room->roommaxguest }} guests</p>
                                                                <div class="flex flex-wrap gap-2">
                                                                    <span
                                                                        class="badge px-3 py-1 rounded-full text-white border-white border bg-transparent text-sm">₱{{ $room->roomprice }}/night</span>
                                                                    @if($room->roomfeatures)
                                                                        @foreach(explode(',', $room->roomfeatures) as $feature)
                                                                            <span
                                                                                class="badge px-3 py-1 rounded-full text-yellow-400 border border-yellow-400 bg-transparent text-sm">{{ trim($feature) }}</span>
                                                                        @endforeach
                                                                    @endif
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="p-6">
                                            ...
                                            <div class="relative w-full rounded-xl overflow-hidden" id="promoCarousel">
                                                @foreach($promos as $index => $promo)
                                                    <div class="carousel-slide {{ $index === 0 ? 'block' : 'hidden' }}">
                                                        <img src="{{ $promo->hotelpromophoto }}"
                                                            alt="{{ $promo->hotelpromoname }}"
                                                            class="w-full h-80 object-cover rounded-xl">
                                                        <div
                                                            class="absolute inset-0 bg-gradient-to-r from-black/60 to-black/30 rounded-xl">
                                                        </div>
                                                        <div class="absolute inset-0 p-8 flex items-center">
                                                            <div class="text-white max-w-2xl">
                                                                <h3 class="text-3xl font-bold mb-3">{{ $promo->hotelpromoname }}
                                                                </h3>
                                                                <p class="text-xl mb-2 opacity-90">
                                                                    {{ $promo->hotelpromodaterange }}
                                                                </p>
                                                                ...
                                                                @if($promo->hotelpromotag)
                                                                    <div class="flex flex-wrap gap-2">
                                                                        <span
                                                                            class="badge px-3 py-1 rounded-full text-yellow-400 border border-yellow-400 bg-transparent text-sm">{{ $promo->hotelpromotag }}</span>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                        </div>
