<div class=" p-6">
    ...
    <div id="facilitiesSlider" class="flex gap-4 overflow-x-auto snap-x snap-mandatory scroll-smooth pb-4 cursor-grab active:cursor-grabbing
        ...
        @forelse ($facility as $facilities)
            <div onclick="document.getElementById('facilitymodal_{{ $facilities->facilityID }}').showModal()"
                class="group cursor-pointer flex-shrink-0 w-48 snap-start">
...
@foreach ($facility as $facilities)
    <dialog id="facilitymodal_{{ $facilities->facilityID }}" class="rounded-3xl max-w-4xl w-full bg-white shadow-2xl backdrop:bg-black/60 backdrop:backdrop-blur-sm p-0 max-h-[90vh] overflow-hidden
