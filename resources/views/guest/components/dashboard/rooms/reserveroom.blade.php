                    ...
                    <div class="flex flex-col flex-1 overflow-hidden">
                        ...
                        <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 transition-slow">
                            ...
                            <section class="p-6 min-h-screen ">
                                <form autocomplete="off" action="/guestcreatereservation" method="POST" id="reservationForm" enctype="multipart/form-data"
                                        ...
                                        @if ($errors->any())
                                            <div class="bg-white border-l-4 border-red-500 p-4 rounded-lg shadow mb-4">
                                                <div class="flex items-start">
                                                    <!-- Icon wrapper -->
                                                    <div
                                                        class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-900 mr-3">
                                        ...
                                        <div class="bg-white/95  rounded-3xl p-8 shadow-2xl border border-white/20">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div class="form-control">
                                                    ...
                                                    <input type="number" name="reservation_adults" min="1" value="1"
                                                        class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors"
                                                        required />
                                                </div>
                                                ...
                                                <div class="form-control">
                                                    ...
                                                    <input type="number" name="reservation_children" min="0" value="0"
                                                        class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors"
                                                        required />
                                                </div>
                    ...
                    <div class="bg-white/95  rounded-3xl p-8 shadow-2xl border border-white/20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-control">
                                ...
                                <input value="{{ Auth::guard('guest')->user()->guest_name }}" type="text" name="guestname"
                                    class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors"
                                    required />
                            </div>
                            ...
                            <div class="form-control">
                                ...
                                <input value="{{ Auth::guard('guest')->user()->guest_birthday }}" id="guestbirthday" type="date" name="guestbirthday"
                                    class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors"
                                    required />
                        ...
                        <div class="form-control">
                            ...
                            <input value="" type="tel" id="guestPhone"
                            ...
                            <div class="form-control">
                                ...
                                <input value="{{ Auth::guard('guest')->user()->guest_email }}" type="email" name="guestemailaddress"
                                    class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors"
                                    required />
                            </div>
            ...
            if (file) {
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col flex-wrap sm:flex-row gap-4">
                                                ...
                                                <button type="button" onclick="confirm_modal_bas.showModal()"
                                                    class="btn btn-primary rounded-md btn-sm">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round">
                ...
                <script>
                    ...
                    function calculateSubtotal() {
                        ...
                        // check if guest exceeds max
                        if (totalGuests > maxGuests) {
                            const extraGuests = totalGuests - maxGuests;
                            const extraFeeTotal = extraGuests * additionalFee * numNights; // Per night fee
                            subtotal += extraFeeTotal;

                            noteElement.innerText = `⚠️ Exceeds capacity by ${extraGuests} guest${extraGuests > 1 ? 's' : ''}. ₱${additionalFee.toFixed(2)} fee per extra guest per night (${extraGuests} × ${numNights} night${numNights > 1 ? 's' : ''} = ₱${extraFeeTotal.toFixed(2)})`;
