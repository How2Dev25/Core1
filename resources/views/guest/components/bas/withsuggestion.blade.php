...
<section class="p-5">
    <form autocomplete="off" action="/aisubmit" method="POST" id="reservationForm" class="flex flex-col lg:flex-row gap-6">
        @csrf
            ...
            <div class="bg-white/95 backdrop-blur-md rounded-3xl p-6 shadow-lg border border-white/20">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 bg-gradient-to-br from-[#001f54] to-[#1a3470] rounded-2xl shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="#F7B32B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M3 9.5V22h18V9.5L12 2Z"></path>
                            <path d="M9 22V12h6v10"></path>
                        </svg>
                    </div>
                    <div>
                        <h2 class="text-2xl font-bold bg-gradient-to-r from-[#001f54] to-[#1a3470] bg-clip-text text-transparent">Select a Room</h2>
             ...
             <div class="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-control">
                        ...
                        <input type="date" name="reservation_checkin" value="{{ $checkin }}" class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" required />
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="date" name="reservation_checkout" value="{{ $checkout }}" class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" required />
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" value="{{ $criteria['roommaxguest'] ?? 1 }}"name="reservation_numguest" min="1" class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" required />
                    </div>
                    ...
                    <div class="form-control md:col-span-2">
                        ...
                        <input type="text"  value="{{ $specialRequest }}" name="reservation_specialrequest" placeholder="Early check-in, extra pillows..." class="input input-bordered w-full rounded-xl border-2 border-gray-200 focus:border-[#001f54] focus:outline-none transition-colors" />
                    </div>
                </div>
            </div>
    ...
    Service Fee (2%)
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <button type="button" onclick="confirm_modal_bas2.showModal()" class="btn btn-primary rounded-md btn-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
