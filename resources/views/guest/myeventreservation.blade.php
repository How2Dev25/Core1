                        ...
                        @forelse ($reservations as $reservation)
                                        <div
                                            ...
                                            <div class="relative h-64 overflow-hidden">
                                                <img src="{{ asset($reservation->eventtype_photo) }}" alt="{{ $reservation->event_name }}"
                                            ...
                                            <div class="p-6 space-y-5">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-start gap-3">
                                                        ...
                                                        <div class="flex-1 min-w-0">
                                                            <p class="text-xs font-semibold text-indigo-600 uppercase tracking-wide">Organizer</p>
                                                            <p class="text-sm font-bold text-gray-900 truncate">{{ $reservation->eventorganizer_name }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="grid grid-cols-2 gap-4">
                                                    <div class="bg-gray-50 rounded-xl p-3 border border-gray-200">
                                                        ...
                                                        <p class="text-xl font-black text-gray-900">{{ $reservation->event_numguest }}</p>
                                                    </div>
                        ...
                        @empty
                            <div
                                ...
                                <div class="relative">
                                    ...
                                    <div class="relative bg-white p-8 rounded-full shadow-2xl mb-8 border-4 border-indigo-100">
                                ...
                                <p class="text-gray-600 text-lg max-w-md leading-relaxed mb-6">
                                    You haven't booked any event or conference yet. Browse our available event packages to get started.
                                </p>
                                <a href="#"
