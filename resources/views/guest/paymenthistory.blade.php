            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 transition-slow ">
                    ...
                    <div class="pb-5 border-b border-base-300 animate-fadeIn">
                        <h1 class="text-2xl font-bold bg-white bg-clip-text text-[#191970]">Payments History
                        </h1>
                    </div>
                    {{-- Subsystem Name --}}
                    ...
                    <section class="flex-1 p-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <!-- Total Revenue -->
                                <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-lg hover:shadow-xl transition">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h3 class="text-sm font-medium text-gray-600 uppercase tracking-wide">Total Payments</h3>
                                ...
                                <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-lg hover:shadow-xl transition">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h3 class="text-sm font-medium text-gray-600 uppercase tracking-wide">Total Transactions</h3>
                                            <p class="text-2xl font-bold text-gray-800 mt-2">{{ $totalTransaction }}</p>
                                            <div class="flex items-center mt-3">
                                ...
                                <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-lg hover:shadow-xl transition">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h3 class="text-sm font-medium text-gray-600 uppercase tracking-wide">Upcoming Bookings</h3>
                                            <p class="text-2xl font-bold text-gray-800 mt-2">{{ $upcomingBookings ?? 0 }}</p>
                                            <div class="flex items-center mt-3">
                                                <span class="text-sm font-medium text-gray-500">Future Stays</span>
                                            </div>
                                        </div>
                                        <div class="w-16 h-16 rounded-xl flex items-center justify-center bg-blue-900">
                                ...
                                <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-lg hover:shadow-xl transition">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h3 class="text-sm font-medium text-gray-600 uppercase tracking-wide">Last Payment</h3>
                                            <p class="text-2xl font-bold text-gray-800 mt-2">
                                                ₱{{ number_format($lastPaymentAmount ?? 0, 2) }}
                                            </p>
                                            <div class="flex items-center mt-3">
                                                <span class="text-sm font-medium text-gray-500">{{ $lastPaymentDate ?? '-' }}</span>
                                            </div>
                                        </div>
                                        <div class="w-16 h-16 rounded-xl flex items-center justify-center bg-blue-900">
