              ...
              <div class="container mx-auto px-4 py-8">
                <div class="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-8">
                  ...
                  @forelse ($reserverooms as $reserveroom)
                                    <div
                                      class="bg-white border border-gray-100 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                                      <!-- Room Image Header -->
                                      <div class="relative h-48 overflow-hidden bg-gradient-to-br from-[#001f54] to-[#003875]">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-t from-[#001f54]/60 via-transparent to-transparent">
                                        </div>
                                      ...
                                      <div class="p-6">
                                        ...
                                        <div class="grid grid-cols-2 gap-4 mb-6">
                                          <div class="bg-gray-50 rounded-xl p-4">
                                            <div class="flex items-center mb-2">
                                              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#001f54]" fill="none"
                                        ...
                                        <div class="bg-gradient-to-r from-[#001f54] to-[#003875] rounded-xl p-5 mb-6 text-white">
                                          ...
                                          <div class="flex items-center mb-4">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-[#F7B32B]" fill="none"
                                              viewBox="0 0 24 24" stroke="currentColor">
                                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    $bookedDate = date('M d, Y', strtotime($reserveroom->reservation_created_at));
                                          ...
                                          <div class="space-y-3">
                                            ...
                                            <div class="border-t border-white/20 pt-3 space-y-2">
                                              ...
                                              <div class="flex justify-between items-center text-sm">
                                                <span class="opacity-90">VAT ({{$taxRatedynamic}}):</span>
                                                <span class="font-semibold">₱{{ number_format($vat, 2) }}</span>
                                              </div>

                                              <div class="flex justify-between items-center text-sm">
                                                <span class="opacity-90">Service Fee ({{ $serviceFeedynamic }}):</span>
