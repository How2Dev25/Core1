<div class="mb-6" wire:poll.5s> <!-- Refresh every 500ms -->
  <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
    <h3 class="text-xl font-bold text-gray-800">Book A Room</h3>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
    @forelse ($rooms as $room)
      <a href="/selectedroom/{{$room->roomID}}" class="card bg-base-100 shadow-sm hover:shadow-lg border-2 border-transparent hover:border-primary transition-all cursor-pointer relative group">
