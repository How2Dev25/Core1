...
<section class="p-6 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 min-h-screen mt-20">
    <form autocomplete="off" action="/guestcreatereservationlanding" method="POST" id="reservationForm" class="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto">
        @csrf
    ...
    Service Fee (2%)
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <button type="button" onclick="confirm_modal_bas.showModal()" class="btn btn-primary rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
