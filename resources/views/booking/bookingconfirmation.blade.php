...
<div class="flex h-screen overflow-hidden">
    ...
    <form  autocomplete="off" action="/guestcreatereservationlanding" method="POST" id="reservationForm" class="flex flex-col lg:flex-row gap-6">
        @csrf
            ...
            <div class="rounded-box p-6 shadow bg-base-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-control">
                        ...
                        <input value="" type="text" name="guestname" class="input input-bordered w-full" required />
                    </div>
                    <div class="form-control">
                        <label class="label font-medium">Birthday</label>
                        <input  value="" id="guestbirthday" type="date" name="guestbirthday" class="input input-bordered w-full" required />
                    ...
                    <div class="form-control">
                        ...
                        <input value="" type="tel" name="guestphonenumber" class="input input-bordered w-full" required />
                    </div>
                    <div class="form-control">
                        <label class="label font-medium">Email Address</label>
                        <input value="" type="email" name="guestemailaddress" class="input input-bordered w-full" required />
                    </div>
                    <div class="form-control md:col-span-2">
