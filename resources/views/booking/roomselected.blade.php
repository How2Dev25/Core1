...
<head>
    ...
    <title>{{$title}} - Room Selected</title>
</head>
        ...
        <div class="mb-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1
                            class="text-4xl font-bold bg-gradient-to-r from-[#001f54] to-[#1a3470] bg-clip-text text-transparent">
                            Room Details
                        </h1>
                ...
                <div class="flex items-center gap-4">
                    <span
                        class="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 text-white text-sm font-semibold shadow-lg">
                ...
                <div class="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden border border-white/20">
                    <div class="relative group">
                        <div class="aspect-[16/10] overflow-hidden">
                            <img src="{{ asset($room->roomphoto) }}" alt="Room Image"
                                class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                        </div>
                        <div class="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent">
                        </div>
                        <div
                            class="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <button
                                class="btn btn-circle bg-white/20 backdrop-blur-md border-0 hover:bg-white/30 text-white">
                        ...
                        <div class="absolute bottom-6 left-6">
                            <div
                                class="inline-flex items-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-md text-white border border-white/20">
                ...
                <div class="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white/20">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
                        @forelse ($roomphotos as $roomphoto)
                            <div
                                class="relative group rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 aspect-square border border-gray-100">
                                <img class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110"
                                    src="{{ asset($roomphoto->additionalroomphoto) }}" alt="Room image">
                                <div
                        ...
                        @empty
                            <div
                                class="col-span-full flex flex-col items-center justify-center p-12 border-2 border-dashed border-gray-200 rounded-2xl text-center bg-gray-50/50">
    ...
    @forelse ($feedbacks as $myroomfeedback)
          <div class="py-4 px-6  transition-colors duration-200">
            <div class="flex gap-4">
                ...
                <img src="{{ asset($myroomfeedback->guest_photo) }}" 
                    alt="Guest Avatar" 
                ...
                <div class="flex items-center gap-1 mb-2">
                    @for ($i = 1; $i <= 5; $i++)
                    <i class="{{ $i <= $myroomfeedback->roomrating ? 'fa-solid fa-star' : 'fa-regular fa-star' }} text-xs" style="color: #F7B32B;"></i>
                    @endfor
                ...
                @if(!empty($myroomfeedback->roomfeedbackphoto))
                    <div class="mb-3">
                    <img src="{{ asset($myroomfeedback->roomfeedbackphoto) }}" 
                        alt="Feedback Photo" 
...
<!-- Guest Feedbacks Section -->
            ...
            <div
                class="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-white/20 h-fit sticky top-8 xl:col-span-1">
                <!-- Room Info -->
                ...
                <div class="space-y-6">
                    <!-- room details cards -->
                    <div
                        class="flex items-center p-4 rounded-xl bg-gradient-to-r from-[#001f54]/5 to-[#1a3470]/5 border border-[#001f54]/10">
                    ...
                    <div
                        class="flex items-center p-4 rounded-xl bg-gradient-to-r from-green-500/5 to-emerald-500/5 border border-green-500/20">
                        <div class="p-2 bg-[#001f54] rounded-lg mr-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="#F7B32B" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                    ...
                    <div
                        class="p-4 rounded-xl bg-gradient-to-r from-[#001f54]/5 to-[#1a3470]/5 border border-[#001f54]/10">
                ...
                <!-- CTA -->
                <div class="mt-8">
                    <a href="/bookconfirmlanding/{{ $room->roomID }}" class="w-full btn btn-primary">
                        Book This Room
                    </a>
                </div>
            </div>
